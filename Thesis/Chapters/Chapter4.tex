...
\label{Chapter 4}
\lhead{Chapter 4. \emph{Robot Hardware Implementation}}
...
\begin{figure}[H]
	\vspace{1em}
	\centering
		\includegraphics[width=140mm]{./Figures/HardwareBlockDiagram.png}
	\rule{35em}{0.5pt}
...
\begin{figure}[tbph]
	\centering
		\includegraphics[width=55mm]{./Figures/HBridgeSchematic.png}
	\rule{35em}{0.5pt}
...
\begin{figure}[tbph]
	\centering
		\includegraphics[width=55mm]{./Figures/FlybackDiodeSchematic.png}
		\includegraphics[width=80mm]{./Figures/FlybackDiodes.png}
	\rule{35em}{0.5pt}
