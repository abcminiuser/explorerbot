...
\abstract{
	...
	To combat this lack, this project is designed to produce a free, open source, small footprint Bluetooth stack
	aimed at to suit embedded environments, to allow for Bluetooth technology to be directly integrated into small
	scale products at a low cost, while remaining fully functional and extensible.
}
...
\acknowledgements{
	...
	Thank you to the wider AVR community for their interest and support for the project, and to Matt from \emph{Opendous Inc.}
	for his contribution of free \emph{Micropendous} AVR microcontroller boards used in the final robot prototype.
}
