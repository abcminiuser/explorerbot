...
\acknowledgements{
	...
	Thank you to the wider AVR community for their interest and support for the project, and to Matt from {\i Opendous Inc.}
	
	for his contribution of free {\it Micropendous} AVR microcontroller boards used in the final robot prototype.
}
