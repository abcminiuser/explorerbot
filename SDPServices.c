...
static const struct
{
...
} PROGMEM SerialPort_Attribute_LanguageBaseIDOffset =
	{
		...
		{
			{
				{(SDP_DATATYPE_UnsignedInt | SDP_DATASIZE_16Bit), CPU_TO_BE16(0x454E)},
				{(SDP_DATATYPE_UnsignedInt | SDP_DATASIZE_16Bit), CPU_TO_BE16(0x006A)},
				{(SDP_DATATYPE_UnsignedInt | SDP_DATASIZE_16Bit), CPU_TO_BE16(0x0100)},
			},
		},
	};
 ...
 */
const ServiceAttributeTable_t PROGMEM SDP_SerialPort_AttributeTable[] =
	{
